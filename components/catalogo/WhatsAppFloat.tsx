...
const WHATSAPP_URL =
  'https://wa.me/573057510901?text=Hola!%20Quiero%20ver%20el%20cat%C3%A1logo%20de%20Pura%20Pasi%C3%B3n'
...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 py-3 px-4 rounded-full transition-all duration-300 hover:scale-105"
      style={{
        background: '#25D366',
        color: '#fff',
